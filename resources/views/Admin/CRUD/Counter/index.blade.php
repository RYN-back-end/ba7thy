...
@endsection
@section('routes')
    <li class="breadcrumb-item active" aria-current="page"> {{helperTrans('admin.counters')}}</li>
@endsection
@section('content')

    <div class="card">
        {!! indexButtons(helperTrans('admin.counters'),helperTrans('admin.new counter')) !!}
        <div class="card-body">
            <!-- data table -->
            <table id="dataTable" class="table myDataTable align-middle custom-table">
                ...
                <tr>
                    ...
                    <th>{{helperTrans('admin.number')}}</th>
...
@section('scripts')
    ...
    @include('Admin.layout.inc.ajax',['url'=>'counters','modalSize'=>'fullscreen'])
@endsection
