...
@section('content')
    <div class="card">
        ...
        @endif
<form class="row g-3" style="padding: 20px" action="{{route('articles.store')}}" id="form" enctype="multipart/form-data" method="POST">
    @csrf
    ...
    <div class="col-12">
        <div class="mb-2">
            ...
            <input type="file" class="dropify" name="image" data-default-file="" required accept="image/*"/>
        </div>
    </div>
