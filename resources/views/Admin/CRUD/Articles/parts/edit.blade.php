...
@section('content')
    <div class="card">
        ...
        @endif
        <form class="row g-3" style="padding: 20px" action="{{route('articles.update',$obj->id)}}" id="form" enctype="multipart/form-data"
              method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="col-6">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control form-control-lg" name="meta_title_en" required
                           value="{{$obj->meta_title_en}}">
                </div>
            </div>
            <div class="col-12">
                <div class="mb-2">
                    <label class="form-label"> وصف meta بالعربي</label>
                    <textarea rows="4" class="form-control form-control-lg" name="meta_desc_ar"
                              required>{{$obj->meta_desc_ar}}</textarea>
                </div>
            </div>
            <div class="col-12">
                <div class="mb-2">
                    <label class="form-label"> وصف meta بالانجليزي</label>
                    <textarea rows="4" class="form-control form-control-lg" name="meta_desc_en"
                              required>{{$obj->meta_desc_en}}</textarea>
                </div>
            </div>
