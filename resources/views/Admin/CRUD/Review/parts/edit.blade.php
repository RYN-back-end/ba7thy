<form class="row g-3" action="{{route('reviews.update',$obj->id)}}" id="form" enctype="multipart/form-data"
      method="POST">
    @csrf
    @method('PUT')
    <div class="col-12">
    ...
    <div class="col-6">
        <div class="mb-2">
            ...
            <input type="text" class="form-control form-control-lg" name="name_ar" value="{{$obj->name_ar}}" required
    ...
    <div class="col-6">
        <div class="mb-2">
            <label class="form-label">{{helperTrans('admin.name')}}</label>
            <input type="text" class="form-control form-control-lg" name="name_en" value="{{$obj->name_en}}" required
    ...
    <div class="col-12">
        <div class="mb-2">
            ...
            <textarea rows="3" class="form-control form-control-lg" name="comment_ar"  required
                      placeholder="اكتب التعليق عربي">{{$obj->comment_ar}}</textarea>
        </div>
    </div>
    <div class="col-12">
        <div class="mb-2">
            ...
            <textarea rows="3" class="form-control form-control-lg" name="comment_en" required
                      placeholder="اكتب التعليق انجليزي">{{$obj->comment_en}}</textarea>
        </div>
    </div>
</form>
