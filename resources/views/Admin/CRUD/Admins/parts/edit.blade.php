<form class="row g-3" action="{{route('admins.update',$obj->id)}}" id="form" enctype="multipart/form-data"
      method="POST">
    @csrf
    @method('PUT')
    <div class="col-4">
        <div class="mb-2">
            ...
            <input type="text" class="form-control form-control-lg" name="name" value="{{$obj->name}}" required
    ...
    <div class="col-4">
        <div class="mb-2">
            ...
            <input type="email" class="form-control form-control-lg" name="email" value="{{$obj->email}}" required
