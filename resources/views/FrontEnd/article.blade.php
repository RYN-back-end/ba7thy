                            ...
                            <div class="position-sticky sticky-top">
                                <div class="post-details__social-share">
                                    ...
                                    <div class="social-share">
                                        <a href="https://twitter.com/intent/tweet?text={{route('frontend.article',$obj->id)}}" target="_blank"><i class="fab fa-twitter"></i></a>
                                        <a href="https://api.whatsapp.com/send?text={{route('frontend.article',$obj->id)}}" target="_blank"><i class="fab fa-whatsapp"></i></a>
                                        <a href="https://t.me/share/url?url={{route('frontend.article',$obj->id)}}" target="_blank"><i class="fab fa-telegram"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <aside class="axil-sidebar-area">
                            ...
                            <div class="axil-single-widget mt--40">
                                ...
                                @foreach($another as $row)
                                    ...
                                    <a href="{{route('frontend.article',$row->id)}}">
                                        <div class="content-blog post-list-view mb--20">
                                            ...
                                            <div style="height: 150px;"
                                                ...
                                                <a href="{{route('frontend.article',$row->id)}}"><h5 class="mb-2"> {{$row->title}}</h5></a>
                                            </div>
                                        </div>
